// Given an array of objects. Sort products:
// 1) by the number of reviews.
// 2) by price (if there are two prices, then take newUan)
...
const array = [
  ...
  },
  {
    ...
    price: "4 999 грн",
    name: "Samsung Galaxy J7 J700H/DSBlack + карта памяти 16гб + чехол + защитное стекло!",
  },
  {
  ...
  },
  {
    ...
    price: "16 999 грн",
    name: "Huawei P10 4/32GB Black + сертификат 2500грн + чехол Huawei SmartView Cover!",
  },
  {
  ...
  },
  {
    ...
    name: "HTC One X10 DualSim Silver",
  },
  {
...
// sorting by the number of reviews
array.sort(
  (a, b) =>
    Number(a.ratingRevievs.replace(/\s|\D/g, "")) -
    Number(b.ratingRevievs.replace(/\s|\D/g, ""))
);
...
array.sort((a, b) => {
  const aPrice =
    typeof a.price === "string"
      ? Number(a.price.replace(/\s|\D/g, ""))
      : Number(a.price.newUan.replace(/\s|\D/g, ""));

  const bPrice =
    typeof b.price === "string"
      ? Number(b.price.replace(/\s|\D/g, ""))
      : Number(b.price.newUan.replace(/\s|\D/g, ""));
